...
def write_to_file(extractor, product_count):
    products = {}
    prices = []
...
def from_server(input_word, input_sorting, input_price_low, input_price_high, pincode, product_count):
    input_price_low = int(input_price_low)
    input_price_high = int(input_price_high)
    ...
    objs = write_to_file(e, product_count)
    return objs
